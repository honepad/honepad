...
Report incidents to the maintainers through GitHub, using a private
security advisory when the report itself should stay private:
...
1. **Correction.** A private, written warning and clarity around the
